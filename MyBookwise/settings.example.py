...
CSRF_FAILURE_VIEW = "bookstore.api.debug_logging.csrf_failure"
...
MIDDLEWARE = [
    ...
    "bookstore.api.debug_logging.ApiDebugLoggingMiddleware",
...
LOGGING = {
    ...
    "loggers": {
        "bookstore.api": {
            "handlers": ["console"],
            "level": os.environ.get("API_DEBUG_LOG_LEVEL", "INFO"),
            "propagate": False,
        },
        "django.security": {
            "handlers": ["console"],
