...
-- 订单1: 已取消已退款 - 张三
INSERT INTO `orders` VALUES (1, '2025122201', '2025-12-22 12:48:24', 1, '湖北省武汉市洪山区', 125.10, 125.10, 2, 4);
-- 订单2: 已取消已退款 - 李四
INSERT INTO `orders` VALUES (2, '2025122301', '2025-12-22 18:36:25', 2, '湖北省武汉市武昌区', 2425.90, 2425.90, 2, 4);
-- 订单3: 已下单已付款，待完成 - 李四（测试用：完成后TotalSpent增加）⭐
INSERT INTO `orders` VALUES (3, '2025122302', '2025-12-23 20:20:45', 2, '湖北省武汉市武昌区', 2577.20, 2577.20, 1, 0);
-- 订单4: 已下单已付款 - 张三买2本Python书
INSERT INTO `orders` VALUES (4, '2025122401', '2025-12-24 10:00:00', 1, '湖北省武汉市洪山区', 160.20, 160.20, 1, 0);
-- 订单5: 已发货已付款 - 王五买3本算法导论
